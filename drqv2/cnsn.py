...
class CrossNorm(nn.Module):
    """CrossNorm module
    --crop:    type=str, help='crop a bbx in 2-instance crossnorm: neither/style/content/both
    --beta:    beta distribution to sample the ratio of a cropping bbx for crossnorm

    """
    def __init__(self, crop="style", beta=1):
